...
class TogglePlayersOff extends GUIItem {
	...
	public function onClick(CorePlayer $player) {
		$player->setPlayersVisible(false);
		$player->getInventory()->setItem(7, new TogglePlayersOn());
	}
